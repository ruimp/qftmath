...
\begin{itemize}
  \item Costello - Renormalization and Effective Field Theory \cite{costelloRenormalization2011};
  \item Elliot, Williams, Yoo - Asymptotic Freedom in the BV Formalism \cite{elliottAsymptotic2018};
  \item Gwilliam - Factorization algebras and free field theories \cite{gwilliamFactorization}.
\end{itemize}
